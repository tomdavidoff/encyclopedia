...
world in which they are most needed. Despite
...
homeownership have yet to become popular. A striking trend in North America is
diminished household headship and ownership among younger people. 
...
(see, e.g. \textcite{Poterba}), are not included in owners' expenditure shares.}
...
\textcite{HanushekQuigley} that the price elasticity of demand for housing is less
...
intriguing result of \textcite{DavisFOM} is that despite these low income and price
...
prices, mortgage debt has grown less common among younger homewners and more
...
consistent with the finding of \textcite{VentiWise} and others that death of a
spouse is among the most important triggers of exit from homeownership among
the elderly. \textcite{CoileMilligan} use HRS/AHEAD data to show that the
...
Figure \ref{fig:homeownershipAge_allMetros} plots homeownership rates among
household heads by age for the 2000 Census 5\% sample and the 2020-2024 ACS as
tabulated by \textcite{IPUMS}.  While overall homeownership has been relatively
constant between the two samples, we see large declines between 2000 and
2020-2024 at younger ages (even conditional on household headship) and even
more persistent homeownership among seniors. Notably, the figures are not
notably different in the difference-in-differences among age groups comparing
across metropolitan areas. Figure \ref{fig:homeownershipMetros} plots the same
figure as Figure \ref{fig:homeownershipAge_allMetros} but separately for
notoriously inelastic and increasingly expensive San Francisco and Boston,
versus Chicago and Houston, which have seen more muted price growth (verify).
...
\begin{figure}
	\pgfimage[height=2.5in]{homeownershipAge_sanFrancisco.png}
	\pgfimage[height=2.5in]{homeownershipAge_chicago.png}\\
	\pgfimage[height=2.5in]{homeownershipAge_boston.png}
	\pgfimage[height=2.5in]{homeownershipAge_houston.png}
\end{figure}
...
\textcite{Davidoffltc}, in the 2004 wave of the HRS/AHEAD panel, approximately 12\%
...
\textcite{FlavinYamashita} and \textcite{Brueckner}).  Setting aside moral hazard
...
non-recourse) and on maintenance,\footnote{see, e.g. \textcite{MiceliSirmans}} it
