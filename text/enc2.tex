...
world in which they are most needed. A striking trend in North America is
diminished household headship and ownership among younger people. Despite
decades of marketing efforts, financial products, such as equity sharing and
home price index trading, meant to undo certain allocative effects of
homeownership have yet to become popular.
...
roughly 18\% to 26\%. By contrast, owners collectively spent a relatively
constant share of expenditures, roughly 15\% over time over that period.
Mortgage expenditure shares notably fell, not surprisingly given falling
interest rates and most owners' option to fix rates, offset by rising property
taxes and other shelter expenditures such as maintenance.\footnote{The opportunity cost
of equity and anticipated capital gains, part of true ``user cost''
(see, e.g. \textcite{Poterba}), are not included in these expenditure shares.}

The greater housing expenditure for renters than owners found in the CEX is
...
that value rises to .47.\footnote{These results are conditional only on
	metropolitan area dummies and the year for the 5-year ACS.} Rent
	relative to social security income is higher in larger and more
	expensive metropolitan areas, an interesting counterpoint to the
	finding in Survey data also provide strong support for the nearly experimental result of
